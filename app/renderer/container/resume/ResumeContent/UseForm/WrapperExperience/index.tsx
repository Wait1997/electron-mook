...
export default function WrapperExperience({ dataList, updateDataList, children }: PropsWithChildren<IProps>) {
  // 默认当前索引为-1
  ...
  }, [currentIndex, experienceList, currentItem, onToggleEditModal, updateDataList, editModal.tempSaveItem])
  ...
  }, [children, currentItem, onChangeCurrentItem, editModal?.status])
