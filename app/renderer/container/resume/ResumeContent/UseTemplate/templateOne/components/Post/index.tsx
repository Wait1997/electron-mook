      ...
      <ul className={styles.list}>
        <li className={styles.flex}>
          <div className={styles.left}>
            <p className={styles.title}>2016.09-2017-09</p>
            <p className={styles.title}>大傻逼会长</p>
          </div>
          <div className={styles.right}>
            <p className={styles.title}>校团委学生会</p>
        ...
        <li className={styles.flex}>
          <div className={styles.left}>
            <p className={styles.title}>2017.09-2019.04</p>
            <p className={styles.title}>前端工程师</p>
          </div>
          <div className={styles.right}>
            <p className={styles.title}>湖南瞎说大学网络中心</p>
            <p className={styles.title}>
